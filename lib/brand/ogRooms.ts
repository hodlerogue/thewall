 ...
 * Commons says everyone, music says interests, builders says people make
 * things here — the spread §5 is after.
 *
 ...
 * room costs two.
 */
export const ON_THE_CARD = ['commons', 'music', 'builders'] as const
